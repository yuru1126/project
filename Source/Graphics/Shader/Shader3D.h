...
class Shader3D : public ModelShader
{
public:
	Shader3D(ID3D11Device* device);
	~Shader3D() override {}

	void Load(const char* VS, const char* PS, const char* GS = nullptr, const char* HS = nullptr, const char* DS = nullptr);
