...
public:
	...
	struct Material
	{
		...
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> diffuse_map;//shaderResourceView
		...
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> metallic_map;		//#2022
		Microsoft::WRL::ComPtr<ID3D11ShaderResourceView> roughness_map;	//#2022
